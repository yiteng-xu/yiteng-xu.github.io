...
.milestones-section {
  ...
  --ms-muted: #000000;
  --ms-accent: #c7b9ff; /* pastel lavender */
  --ms-accent-2: #b8f2e6; /* pastel mint */
...
.milestones-controls .view-toggle.active {
  background: linear-gradient(135deg, rgba(199,185,255,.18), rgba(184,242,230,.18));
  border-color: transparent;
}
.milestones-timeline {
  position: relative;
...
.milestones-timeline .timeline-line {
  ...
  bottom: 0;
  width: 3px;
  background: linear-gradient(180deg, rgba(199,185,255,.4), rgba(184,242,230,.4));
...
.milestone .milestone-dot {
  ...
  border-radius: 50%;
  box-shadow: 0 0 0 3px rgba(199,185,255,0.25), 0 0 18px rgba(184,242,230,0.5), inset 0 0 6px rgba(255,255,255,0.8);
  transform: translateX(-50%);
}
...
.chip-link {
  ...
  border-color: rgba(199,185,255,.45);
}
...
@keyframes ms-pulse {
  0% { box-shadow: 0 0 0 3px rgba(199,185,255,0.25), 0 0 18px rgba(184,242,230,0.5), inset 0 0 6px rgba(255,255,255,0.8); }
  70% { box-shadow: 0 0 0 8px rgba(199,185,255,0.12), 0 0 28px rgba(184,242,230,0.7), inset 0 0 6px rgba(255,255,255,0.8); }
  100% { box-shadow: 0 0 0 3px rgba(199,185,255,0.25), 0 0 18px rgba(184,242,230,0.5), inset 0 0 6px rgba(255,255,255,0.8); }
}
...
.news-section {
  ...
  --nw-muted: #000000;
  --nw-ac1: #c7b9ff; /* pastel lavender */
  --nw-ac2: #b8f2e6; /* pastel mint */
...
.news-accent {
  ...
  background:
    radial-gradient(600px 220px at var(--mx, 50%) var(--my, 50%), rgba(199,185,255,.28), transparent 60%),
    radial-gradient(600px 220px at calc(var(--mx, 50%) + 140px) calc(var(--my, 50%) + 40px), rgba(184,242,230,.24), transparent 65%);
...
.news-source { border-color: rgba(199,185,255,.45); }
...
.skills-section {
  ...
  --sk-muted: #000000;
  --sk-accent-1: #c7b9ff; /* pastel lavender */
  --sk-accent-2: #b8f2e6; /* pastel mint */
  --sk-accent-3: #ffd1dc; /* pastel pink */
  --sk-accent-4: #ffd5a5; /* pastel peach */
...
.skills-aurora {
  ...
  background:
    radial-gradient(1200px 800px at 10% 20%, rgba(199,185,255,.28), transparent 45%),
    radial-gradient(1000px 700px at 90% 10%, rgba(184,242,230,.28), transparent 45%),
    radial-gradient(900px 700px at 80% 80%, rgba(255,209,220,.25), transparent 50%),
    radial-gradient(900px 700px at 20% 85%, rgba(255,213,165,.22), transparent 50%);
...
.skills-mode:hover { border-color: transparent; box-shadow: 0 0 0 3px rgba(199,185,255,.18); transform: translateY(-1px); }
.skills-mode.active { background: linear-gradient(135deg, rgba(199,185,255,.2), rgba(184,242,230,.2)); border-color: transparent; }
...
.card-accent { position: absolute; inset: -20% -30% auto -30%; height: 120px; background: radial-gradient(700px 200px at 30% 50%, rgba(199,185,255,.35), transparent 60%), radial-gradient(700px 200px at 70% 50%, rgba(184,242,230,.35), transparent 60%); filter: blur(24px) saturate(130%); pointer-events: none; }
...
.skill-chip:hover { transform: translateY(-2px); border-color: transparent; background: linear-gradient(135deg, rgba(199,185,255,.25), rgba(184,242,230,.25)); }
.chip-hot { border-color: rgba(199,185,255,.45); }
...
.card-toggle:hover { border-color: transparent; box-shadow: 0 0 0 3px rgba(199,185,255,.15); transform: translateY(-1px); }
...
.float-chip { font-size: .85rem; padding: .35rem .7rem; border-radius: 999px; border: 1px solid var(--sk-border); background: linear-gradient(135deg, rgba(199,185,255,.22), rgba(184,242,230,.22)); color: var(--sk-text); box-shadow: 0 8px 24px rgba(16,24,40,.18); animation: float 5.5s ease-in-out infinite; }
    ...
    <svg class="curve-svg" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
      <defs>
        <linearGradient id="awGrad" x1="0%" y1="0%" x2="100%" y2="0%">
          <stop offset="0%" stop-color="#c7b9ff"/>
...
.awards-section {
  ...
  --aw-muted: #000000;
  --aw-ac1: #c7b9ff; /* pastel lavender */
  --aw-ac2: #b8f2e6; /* pastel mint */
...
.awards-toggle:hover { border-color: transparent; box-shadow: 0 0 0 3px rgba(199,185,255,.18); transform: translateY(-1px); }
.awards-toggle.active { background: linear-gradient(135deg, rgba(199,185,255,.22), rgba(184,242,230,.22)); border-color: transparent; }
...
.awards-stairs {
  ...
  background:
    radial-gradient(900px 380px at 10% 90%, rgba(199,185,255,.08), transparent 60%),
    radial-gradient(900px 380px at 80% 20%, rgba(184,242,230,.10), transparent 65%);
  border-radius: 16px;
  overflow: hidden;
  isolation: isolate;
}
.awards-stairs::after {
  ...
  background: linear-gradient(90deg, rgba(199,185,255,.25), rgba(184,242,230,.25));
}
.step {
  position: relative;
  align-self: end;
...
.step::before {
  ...
  background:
    radial-gradient(500px 180px at 50% 0%, rgba(199,185,255,.22), transparent 60%),
    radial-gradient(500px 180px at 60% 10%, rgba(184,242,230,.22), transparent 70%);
...
.node::before { content: ""; position: absolute; inset: 6px; border-radius: 50%; background: #fff; box-shadow: 0 0 0 2px rgba(199,185,255,.5); }
.node.top::before { box-shadow: 0 0 0 2px rgba(184,242,230,.6); }
.node:hover::before, .node:focus-visible::before { box-shadow: 0 0 0 3px rgba(199,185,255,.6), 0 8px 24px rgba(16,24,40,.3); }
...
.skill-points {
  ...
  --sp-ac1: #c7b9ff; /* pastel lavender */
  --sp-ac2: #b8f2e6; /* pastel mint */
...
.sp-chip:focus-visible { outline: none; box-shadow: 0 0 0 3px rgba(199,185,255,.18), 0 16px 46px rgba(16,24,40,.25); }
